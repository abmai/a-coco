...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:T3Tools/ArenaPair.git")).toBe(
      "github.com/t3tools/arenapair",
    );
    expect(normalizeGitRemoteUrl("https://github.com/T3Tools/ArenaPair.git")).toBe(
      "github.com/t3tools/arenapair",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/T3Tools/ArenaPair")).toBe(
      "github.com/t3tools/arenapair",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:T3Tools/platform/ArenaPair.git")).toBe(
      "gitlab.com/t3tools/platform/arenapair",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/T3Tools/platform/ArenaPair.git")).toBe(
      "gitlab.com/t3tools/platform/arenapair",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:T3Tools/ArenaPair.git"),
    ).toBe("T3Tools/ArenaPair");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/T3Tools/ArenaPair.git"),
    ).toBe("T3Tools/ArenaPair");
  });
});
