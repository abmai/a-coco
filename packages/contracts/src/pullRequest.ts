...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set ARENAPAIR_BITBUCKET_EMAIL and ARENAPAIR_BITBUCKET_API_TOKEN, or ARENAPAIR_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check ARENAPAIR_BITBUCKET_EMAIL and ARENAPAIR_BITBUCKET_API_TOKEN.",
  },
};
