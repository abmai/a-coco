...
const ANDROID_PACKAGE = "com.t3tools.arenapair";
const APP_SCHEME = "arenapair";
...
const IOS_APP_PATH = NodePath.join(
  MOBILE_ROOT,
  ".showcase/ios-derived-data/Build/Products/Debug-iphonesimulator/ArenaPair.app",
);
...
async function buildIos(): Promise<string> {
  ...
  await runCommand(
    ...
    [
      "-workspace",
      NodePath.join(MOBILE_ROOT, "ios/ArenaPair.xcworkspace"),
      "-scheme",
      "ArenaPair",
      "-configuration",
      "Debug",
