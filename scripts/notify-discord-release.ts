  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Arena Pair prerelease is available for nightly testers."
          : "A new Arena Pair latest release is available.",
...
).pipe(Command.withDescription("Post a Arena Pair release announcement to Discord."));
