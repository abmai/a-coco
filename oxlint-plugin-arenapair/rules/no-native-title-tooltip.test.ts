...
const rule = createOxlintRuleHarness("arenapair/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("arenapair/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Arena Pair";`);
