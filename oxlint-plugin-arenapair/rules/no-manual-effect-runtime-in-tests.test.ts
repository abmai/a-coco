...
const rule = createOxlintRuleHarness("arenapair/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("arenapair/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("arenapair/no-manual-effect-runtime-in-tests");
