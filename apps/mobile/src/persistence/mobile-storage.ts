...
const CONNECTIONS_KEY = "arenapair.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "arenapair.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "arenapair.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "arenapair.recent-thread-shortcuts";
