...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "arenapair:version-mismatch-dismissals:v1";
...
/**
 * The skew a user can act on: the connected server runs an older Arena Pair than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same Arena Pair version.",
  };
}
