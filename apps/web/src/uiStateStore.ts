...
export const PERSISTED_STATE_KEY = "arenapair:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "arenapair:renderer-state:v8",
  "arenapair:renderer-state:v7",
  "arenapair:renderer-state:v6",
  "arenapair:renderer-state:v5",
  "arenapair:renderer-state:v4",
  "arenapair:renderer-state:v3",
