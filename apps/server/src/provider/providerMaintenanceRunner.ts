            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Arena Pair could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Arena Pair still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
