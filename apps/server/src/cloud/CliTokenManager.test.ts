...
const TEST_ENV = {
  ARENAPAIR_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  ARENAPAIR_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  ARENAPAIR_HOSTED_APP_URL: "https://hosted.example.test",
};
