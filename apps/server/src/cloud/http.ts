  ...
  Effect.mapError(
    () =>
      new EnvironmentHttpInternalServerError({
        message: "ARENAPAIR_RELAY_URL must be configured as a secure absolute HTTPS origin.",
      }),
  ),
);
...
export const releaseManagedTunnelOnShutdown = Effect.fn(
  ...
  // persisted URL: ARENAPAIR_RELAY_URL may have changed since the link was made.
