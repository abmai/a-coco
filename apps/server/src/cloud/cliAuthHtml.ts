...
declare const __ARENAPAIR_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __ARENAPAIR_BUILD_CHANNEL__ === "undefined" ? "dev" : __ARENAPAIR_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Arena Pair (Dev)",
  nightly: "Arena Pair (Nightly)",
  latest: "Arena Pair",
