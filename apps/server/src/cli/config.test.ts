          ...
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ARENAPAIR_LOG_LEVEL: "Warn",
                  ARENAPAIR_MODE: "desktop",
                  ARENAPAIR_PORT: "4001",
                  ARENAPAIR_HOST: "0.0.0.0",
                  ARENAPAIR_HOME: baseDir,
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  ARENAPAIR_DEV_ALLOWED_ORIGINS:
                    "https://host.example.ts.net, https://phone.example.ts.net ",
                  ARENAPAIR_NO_BROWSER: "true",
                  ARENAPAIR_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  ARENAPAIR_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  ARENAPAIR_PORT: "4001",
                  ARENAPAIR_HOST: "0.0.0.0",
                  ARENAPAIR_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  ARENAPAIR_NO_BROWSER: "false",
                  ARENAPAIR_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  ARENAPAIR_LOG_WS_EVENTS: "false",
                },
              }),
            ),
            NetService.layer,
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ARENAPAIR_BOOTSTRAP_FD: String(fd),
                  ARENAPAIR_NO_BROWSER: "true",
                  ARENAPAIR_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  ARENAPAIR_LOG_WS_EVENTS: "true",
                },
              }),
            ),
