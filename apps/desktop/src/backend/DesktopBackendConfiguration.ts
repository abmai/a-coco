...
const DESKTOP_BACKEND_ENV_NAMES = [
  "ARENAPAIR_PORT",
  "ARENAPAIR_MODE",
  "ARENAPAIR_NO_BROWSER",
  "ARENAPAIR_HOST",
  "ARENAPAIR_DESKTOP_WS_URL",
  "ARENAPAIR_DESKTOP_LAN_ACCESS",
  "ARENAPAIR_DESKTOP_LAN_HOST",
  "ARENAPAIR_DESKTOP_HTTPS_ENDPOINTS",
  "ARENAPAIR_TAILSCALE_SERVE",
  "ARENAPAIR_TAILSCALE_SERVE_PORT",
] as const;
...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's ARENAPAIR_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus ARENAPAIR_HOME (dev-runner
  ...
  for (const [key, value] of Object.entries(process.env)) {
    if (key === "ARENAPAIR_HOME") continue;
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus ARENAPAIR_HOME; pass it
