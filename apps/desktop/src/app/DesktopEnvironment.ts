...
const APP_BASE_NAME = "Arena Pair";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "arenapair-dev" : "arenapair";
  const legacyUserDataDirName = isDevelopment ? "Arena Pair (Dev)" : "Arena Pair (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.arenapair.dev" : "com.t3tools.arenapair",
    ),
    linuxDesktopEntryName: isDevelopment ? "arenapair-dev.desktop" : "arenapair.desktop",
    linuxWmClass: isDevelopment ? "arenapair-dev" : "arenapair",
