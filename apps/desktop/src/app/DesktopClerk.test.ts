...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "arenapair-dev" : "arenapair",
    legacyUserDataDirName: isDevelopment ? "Arena Pair (Dev)" : "Arena Pair (Alpha)",
...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "arenapair-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, ["setPath:userData:/tmp/app-data/arenapair-dev", "createClerkBridge"]);
  ...
  it.each([
    { isDevelopment: true, scheme: "arenapair-dev" },
    { isDevelopment: false, scheme: "arenapair" },
