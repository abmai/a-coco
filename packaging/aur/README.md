...
This directory maintains the [`arenapair-bin`](https://aur.archlinux.org/packages/arenapair-bin) and
[`arenapair-nightly-bin`](https://aur.archlinux.org/packages/arenapair-nightly-bin) packages. Both
